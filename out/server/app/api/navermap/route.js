...
async function GET(req, res) {
    ...
    const response = await axios/* default */.Z.get("https://naveropenapi.apigw.ntruss.com/map-geocode/v2/geocode", {
        params: {
            query: query
        },
        headers: {
...
const routeModule = new AppRouteRouteModule({
    definition: {
        ...
        page: "/api/navermap/route",
        pathname: "/api/navermap",
        filename: "route",
...
const originalPathname = "/api/navermap/route";
